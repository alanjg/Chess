...
var ChessEngine = (function () {
    ...
    ChessEngine.prototype.isValidMove = function (sr, sc, er, ec) {
        return true;
    };
    ChessEngine.prototype.makeMove = function (sr, sc, er, ec) {
    };
    ChessEngine.prototype.makeBestMove = function () {
    };
    ChessEngine.prototype.isValidMoveStart = function (sr, sc) {
        return true;
    };
    ChessEngine.prototype.initializeBoard = function () {
    };
    ChessEngine.prototype.getPiece = function (r, c) {
        return "lightKing";
    };
    return ChessEngine;
})();
...
(function (MochaChessApp) {
    ...
    (function (Application) {
        Application.engine = new ChessEngine();
        Application.pieces = [];
        ...
        function addPiece(pieceName, row, col) {
            ...
            var board = document.querySelector('#board');
            var piece = document.querySelector('#' + pieceName).cloneNode(true);
